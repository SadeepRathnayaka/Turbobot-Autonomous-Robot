...
#include "turbobot_localization/odometry_motion_model.hpp"
#include <tf2/utils.h>
            ...
            
{
    ...
    if (nr_samples_ > 0 ){
        ...
        RCLCPP_FATAL_STREAM(rclcpp::get_logger("OdometryMotionModel"), "Invalid sample size : " << nr_samples_ << "! Exit...");
        return;
    }

    odom_sub_ = create_subscription<nav_msgs::msg::Odometry>("/turbobot_controller/odom", 10,
...
double OdometryMotionModel::angle_diff(double a, double b){
